/* Python code is pre-scanned for symbols in the rupy-ast.

This ensures that global and nonlocal keywords are picked up.
Then the rupy-compiler can use the symbol table to generate proper
...
use crate::IndexMap;
use rupy_ast::{self as ast, Location};
use std::borrow::Cow;
use std::fmt;
