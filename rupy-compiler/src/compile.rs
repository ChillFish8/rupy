//!
//! Take an AST and transform it into rupy-bytecode
//!
//! Inspirational code:
...
use rupy_ast as ast;
use rupy_bytecode::{self as bytecode, CodeObject, ConstantData, Instruction};
use std::borrow::Cow;
...
pub struct CompileOpts {
    /// How optimized the rupy-bytecode output should be; any optimize > 0 does
...
/// Compile an rupy-ast::Mod produced from rustpython_parser::rupy-parser::parse()
pub fn compile_top(
    ast: &ast::Mod,
    source_path: String,
    opts: CompileOpts,
...
/// Compile a standard Python program to rupy-bytecode
...
/// Compile a Python program to rupy-bytecode for the context of a REPL
...
impl Compiler {
    ...
    // could take impl Into<Cow<str>>, but everything is borrowed from rupy-ast structs; we never
    ...
    fn compile_function_def(
        ...
        // Create rupy-bytecode for this function:
