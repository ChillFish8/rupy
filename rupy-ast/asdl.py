...
# The ASDL rupy-parser itself comes next. The only interesting external interface
...
class ASDLParser:
    ...
    This is a simple recursive descent rupy-parser that uses tokenize_asdl for the
    lexing.
    """
    def __init__(self):
