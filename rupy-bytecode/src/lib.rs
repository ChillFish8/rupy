...
//! implements rupy-bytecode structure.

#![doc(html_logo_url = "https://raw.githubusercontent.com/RustPython/RustPython/master/logo.png")]
#![doc(html_root_url = "https://docs.rs/rustpython-rupy-bytecode/")]
...
/// A Single rupy-bytecode instruction.
...
pub enum Instruction {
    ...
    /// Marker rupy-bytecode for the end of a finally sequence.
    /// When this rupy-bytecode is executed, the eval loop does one of those things:
    /// - Continue at a certain rupy-bytecode position
...
impl fmt::Display for CodeDeserializeError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            Self::Other => f.write_str("invalid rupy-bytecode"),
        }
    }
}
...
impl CodeObject<ConstantData> {
    ...
    /// Serialize this rupy-bytecode to bytes.
